...
type SSEEvent = SSEErrorEvent | SSEDoneEvent | SSEThinkingEvent | SSEContextStatsEvent | SSEToolStartEvent | SSEToolCallEvent | SSECacheStatsEvent | SSECitationEvent | SSEDiagnosticsEvent | SSEWorkerProgressEvent | SSEReasoningEvent | SSEActiveModelEvent | SSERateLimitedEvent | SSEChangePreviewEvent | SSEExecutionOutcomeEvent;
              ...
              if (sseEvent.type === 'execution_outcome') {
                const normalizedOutcome =
                  intentMode === 'code' && sseEvent.outcome === 'no-change'
                    ...
                    : sseEvent.outcome;
                const failureMeta = {
                  failureReason: sseEvent.failureReason ?? undefined,
                  suggestedAction: sseEvent.suggestedAction ?? undefined,
                  failedTool: sseEvent.failedTool ?? undefined,
                  failedFilePath: sseEvent.failedFilePath ?? undefined,
                  reviewFailedSection: sseEvent.reviewFailedSection ?? undefined,
                  verificationEvidence: sseEvent.verificationEvidence ?? undefined,
                };
