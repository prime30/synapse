  ...
  return (
    <form onSubmit={handleSubmit} className={`flex flex-col gap-3 px-3 ${className}`}>
      ...
      <button
        ...
        className="w-full px-3 py-2 text-xs font-medium rounded bg-white dark:bg-[#1e1e1e] ide-text hover:bg-stone-100 dark:hover:bg-white/15 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
      >
