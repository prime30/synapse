! function(t) {
    ...
    var e = t(window),
        ...
        p = function() {
            ...
            function A(e) {
                this.container = e, this.$container = t(e), this.options = JSON.parse(this.$container.attr(l)), this.main = this.options.id || "", this.typeAjax = this.options.type || "LmDefault", this.updateURLPrev = this.options.updateURLPrev || !1, this.isProduct = this.options.isProduct || !1, this.$section = t(`#shopify-section-${this.main}`), this.filter = this.options.typeFilters, this.filterData = [], this.queryParams = {}, this.disableScroll = this.options.disableScroll || !1, this.scrollOffset = this.options.scrollOffset || 100, this.isReloadFilter = !0, this.nouisliderLoaded = !1, this.isbtnLoadMore = !0, this.sort_by = this.options.sort_by, this.$filterArea = this.$section.find("[data-filter-area]"), this.setupEventListeners(), this.onFirstLoadFacets(), this.isOpened = function() {
            ...
            return A.prototype = Object.assign({}, A.prototype, {
                ...
                setupEventListenersFacets: function() {
                    var i = this;
                    i.$filter = t("#shopify-section-" + i.filter), i.removeDataDelay(), i.$filter.off(v).on(v, "[data-filter-links] a:not([data-not-a-filter])", function(e) {
                ...
                setupEventListeners: function() {
                    ...
                    i.$container.on(v, ".t4s-active-filters a", function(e) {
                        ...
                        e.preventDefault(), i.isReloadFilter = !1;
                        const a = t(this);
                        a.addClass(w), u = `${a.attr("href")}&section_id=${i.main}`, i.isbtnLoadMore = !t(this).is("[data-is-prev]"), i.renderSectionFromFetch(u, i.main, function(t, e) {
                            i[i.typeAjax](t), a.removeClass(w)
                ...
                loadPageContent: function(e) {
                    ...
                    i.renderSection(e, i.main, function(a, s, n, o) {
                        ...
                        d.length > 0 && d.trigger("destroy.observered"), i.$container.html(l), i.updateListing(), i.isProduct && T4SThemeSP.reinitProductGridItem(), T4SThemeSP.PopupMFP(), r.trigger("t4s:hideTooltip"), r.trigger("currency:update"), "AjaxIsotope" != i.typeAjax && "LmIsotope" != i.typeAjax || (T4SThemeSP.Isotopet4s.init(i.$container.find(".isotopet4s")), T4SThemeSP.ProductItem.resizeObserver()), i.clickOnScrollButton(), i.$filter && i.$filter.length > 0 && !i.isReloadFilter && i.removeDataDelay(), i.$filter && i.isReloadFilter && i.renderSection(e, i.filter, function(e, a, r, s) {
                            if (s) {
                ...
                layoutSwitching: function(i, a, r) {
                    ...
                    0 != n.length && (g = o + "." + l + "." + d, s.$section.on("click", "[data-layout-switch] button", function(e) {
                        e.preventDefault();
                        var i = t(this),
                            a = i.data("breakpoint"),
                            r = i.data("col"),
                            n = s.$container.find(".t4s-products");
                        i.parent().find("." + L).removeClass(L), i.addClass(L), "list_t4s" == r ? n.addClass(P + " on--list-" + a) : n.removeClass(P + " on--list-" + a), "mobile" == a ? (n.removeClass("t4s-row-cols-" + o).addClass("t4s-row-cols-" + r), o = r) : "tablet" == a ? (n.removeClass("t4s-row-cols-md-" + l).addClass("t4s-row-cols-md-" + r), l = r) : (n.removeClass("t4s-row-cols-lg-" + d).addClass("t4s-row-cols-lg-" + r), d = r), n.hasClass("isotopet4s") && n.isotopet4s("layout"), lazySizesT4.autoSizer.checkElems(), isStorageSpdLocal && localStorage.setItem("collection_items_per_row_" + a, d), g = o + "." + l + "." + d, fetch(c + ".js", {
                            body: JSON.stringify({
                ...
                getUrlSortby: function(t) {
                    ...
                    return this.current_sort_by = e, this.initParams(), this.queryParams.page && delete this.queryParams.page, this.queryParams.sort_by = e, "/" == i.substr(i.length - 1) && (i = i.slice(0, -1)), `${i}/?${decodeURIComponent(new URLSearchParams(this.queryParams).toString())}`
                },
                getUrlPriceFilter: function(t, e, i, a) {
                    var r = window.location.pathname;
                    return this.initParams(), this.queryParams.page && delete this.queryParams.page, this.queryParams[t] = i, this.queryParams[e] = a, "/" == r.substr(r.length - 1) && (r = r.slice(0, -1)), `${r}/?${decodeURIComponent(new URLSearchParams(this.queryParams).toString())}`
                },
                onFirstLoadFacets: function() {
                    if (IsDesignMode) {
                        ...
                        t(".t4s-toolbart-filter > a").removeAttr("data-drawer-options").attr("data-drawer-options", `{ "id":"#shopify-section-${a.filter} #t4s-filter-hidden" }`), i.on(h, function(e) {
                            var r = e.detail.sectionId,
                                s = t("#shopify-section-" + r);
                            if (s.hasClass("t4s-section-filter")) s.hasClass("t4s-section-sidebar") && (n = t("#FacetFiltersForm").parent().html(), a.$filterSidebar = t("[data-replace-filter]"), a.$filterSidebar.html(n), a.setupEventListenersSidebarFacets()), a.filter = r, a.setupEventListenersFacets(), a.updateListing(), a.layoutSwitching();
                                ...
                                a.$filterArea.length > 0 ? a.$filterArea.html(e) : t(c).removeAttr("data-drawer-delay").off(v), s.find("[data-replace-filter]").length > 0 && (i.trigger("sidebar:updated"), s.find("[data-replace-filter]").html(e)), (s.find("[data-replace-filter]").length > 0 || a.$filterArea.length > 0) && a.setupEventListenersFacets(), a.updateListing(), a.layoutSwitching()
                            }
                        }), i.on(r, function(i) {
                            let r = i.detail.sectionId,
                                s = t("#shopify-section-" + r);
                            o = t("#t4s-filter-hidden.is--t4s-filter-native"), d = t("#t4s-filter-hidden.is--t4s-filter-tags"), r == p || r == u ? a.$filterArea.length > 0 && e.width() > 767 ? (a.closeFiltersNoAnimation(), r == a.options.typeFilters && r == p && o.length > 0 ? (a.$filterArea.html(o.find("#FacetFiltersForm").parent().html()), a.setupEventListenersFacets()) : r == a.options.typeFilters && r == u && d.length > 0 && (a.$filterArea.html(d.find("#FacetFiltersForm").parent().html()), a.setupEventListenersFacets())) : r == p && o.length > 0 ? T4SThemeSP.Drawer.opend(o) : r == u && d.length > 0 && T4SThemeSP.Drawer.opend(d) : a.$filterArea.length > 0 && e.width() > 767 && s.hasClass("t4s-section-main") && (a.$filterArea.html(a.options.typeFilters == p ? o.find("#FacetFiltersForm").parent().html() : d.find("#FacetFiltersForm").parent().html()), a.setupEventListenersFacets())
                        }), i.on(s, function(i) {
                            let r = i.detail.sectionId;
                            r != p && r != u || (a.$filterArea.length > 0 && e.width() > 767 ? t(c + "." + f).trigger(v) : t(".t4s-close-overlay:visible").trigger("click"))
                        }), a.$filterArea.length > 0 && e.width() > 767 && (a.$filterArea.html(a.options.typeFilters == p ? o.find("#FacetFiltersForm").parent().html() : d.find("#FacetFiltersForm").parent().html()), t(c).removeAttr("data-drawer-delay").off(v), a.setupEventListenersFacets())
                    }
                ...
                ntAjaxStart: function(t = !1) {
                    t || this.scrollToTop(), r.addClass(y), this.$container.addClass(w)
                },
                ntAjaxEnd: function() {
                    r.removeClass(y), this.$container.removeClass(w)
                },
                ...
                clickOnScrollButton: function() {
                    ...
                    0 != i.length && window.IntersectionObserver && i.each(function(i) {
                        let a;
                        (a = new IntersectionObserver(e.handleIntersect, _)).observe(this), t(this).addClass("t4s-lm-onscroll-init")
                    })
                },
