...
export const DEFAULT_ROUTE_CONFIG: ProtectedRouteConfig = {
  publicPaths: ['/', '/auth/signin', '/auth/confirm', '/auth/error', '/auth/forgot-password', '/auth/reset-password', '/auth/mcp', '/pricing', '/signup', '/welcome', '/docs', '/blog', '/benchmarks', '/features', '/download', '/about', '/contact', '/careers', '/changelog', '/roadmap', '/terms', '/privacy', '/security', '/examples'],
