...
function walkDir(dir: string, basePath: string, results: ThemeFile[]): void {
...
export function readThemeFiles(workspacePath: string): ThemeFile[] {
...
export function readThemeFile(workspacePath: string, filePath: string): ThemeFile | null {
