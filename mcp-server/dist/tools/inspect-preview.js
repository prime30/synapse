 ...
 */
export function registerInspectPreviewTools(registry, apiClient, authManager) {
    registry.register({
        definition: {
            name: 'synapse_inspect_preview',
            description: 'Inspect the live Shopify preview DOM to discover elements, app-injected widgets, ' +
        ...
        async handler(args) {
            ...
            try {
                const result = await apiClient.request('POST', `/api/projects/${projectId}/preview/inspect`, {
                    action,
                    selector,
                });
...
//# sourceMappingURL=inspect-preview.js.map