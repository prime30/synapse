 ...
 */
export function registerMediaTools(registry, apiClient, authManager) {
    ...
    registry.register({
        ...
        async handler(args) {
            ...
            try {
                const result = await apiClient.request('POST', '/api/media/generate-image', {
                    prompt,
    ...
    registry.register({
        definition: {
            ...
            description: 'Generate short videos using Veo 3.1. Creates 4-8 second video clips ' +
            ...
            inputSchema: {
                ...
                properties: {
                    prompt: {
                        type: 'string',
                        description: 'Detailed description of the video to generate. Include motion, ' +
        ...
        async handler(args) {
            ...
            try {
                const result = await apiClient.request('POST', '/api/media/generate-video', {
                    prompt,
