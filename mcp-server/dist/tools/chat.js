 ...
 */
export function registerChatTools(registry, apiClient, authManager) {
    registry.register({
        definition: {
            name: 'synapse_get_project_chat',
            description: 'Get the most recent agent chat session and its messages (transcript) for a Synapse project. Use this to read the Synapse IDE chat for a given projectId.',
            inputSchema: {
                type: 'object',
                properties: {
                    projectId: {
