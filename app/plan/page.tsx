...
- Locale/config keys referenced in introduced text exist.
...
export default function PlanPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-[#fafaf9] dark:bg-[#0a0a0a] flex items-center justify-center"><p className="text-sm text-stone-500">Loading plan...</p></div>}>
      <PlanPageInner />
    </Suspense>
  );
}
