              ...
              h = function (t, e) {
                return w.w(
                  c
                    ...
                    [
                      t
                    ].apply(c.toDate("s"), (u ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(e)),
                  c,
                );
              },
              m = this.$W,
  ...
  var f = (function () {
      ...
      function m(e) {
        ((this.$container = e.$container),
          (window.__PFD_VARIANTS__ = this.variants = e.variants),
        ...
        (m.prototype = Object.assign({}, m.prototype, {
          ...
          _updateSwatchFromSizeOne: function () {
            ...
            if (3 == o)
              ...
              ((r = s[0].values.length), (d = s[1].values.length));
            if (
              (o < 2
                ? ((n = 1), (t = this.$options1))
                : 2 == o && 1 == r
          ...
          _updatePrice: function (t, e, i) {
            ...
            // 20% Black Friday Discount Start
            setTimeout(() => {
              const bfSection = document.querySelector(
                ".black_friday_discount",
              );
              if (bfSection) {
                var priceText = document
                  .querySelector("[data-product-price] .hide-price-guest")
                  ?.textContent.trim();

                if (priceText) {
                  var origEl = bfSection.querySelector(
                    ".discounted-price .hide-price-guest",
                  );
                  if (origEl) origEl.textContent = priceText;

                  var clean = priceText.replace(/[^0-9.]/g, "");
                  var priceNum = parseFloat(clean);
                  var discounted = priceNum * 0.8;

                  var finalEl = bfSection.querySelector(
                    ".discounted-price .final-price .hide-price-guest",
                  );
                  if (finalEl)
                    finalEl.textContent =
                      "$" +
                  ...
                  bfSection.style.display = "flex";
                }
              }
            }, 1000);
            // 20% Black Friday Discount End
          },
          ...
          _updateAddToCartButton: function (t, e, i, n, a, o) {
            var $btnText = i.find(".t4s-btn-atc_text");
            ...
            if (i[0] || a[0])
              if (
                ...
                if (t.available) {
                  let labelText = this.variantState.preOrder
                    ? this.txt_preOrder || l
                  ...
                  if (this.isSticky) {
                    ...
                    this.$stickyATCText.text(labelText);
                  }

                  // console.log("[ATC UPDATE] Button updated", {
                  //   variant_id: t.id,
                  //   title: t.name || t.title,
                  //   preOrder: this.variantState.preOrder,
                  //   label: labelText
                  // });
                } else {
                  n.hide();
        ...
        _createBadgesProduct: function () {
          ...
          for (let t = 0; t < a; t++)
            switch (e[t]) {
              ...
              case "sold":
                if (!V) break;
                n += `<span data-badge-sold class="t4s-badge-item sold_badge"${
                  i.available ? " hidden" : ""
                }>${E[e[t]]}</span>`;
                break;
              case "preOrder":
              ...
              function (e) {
                ...
                (n.find("." + d).removeClass(d),
                  ...
                  o
                    ...
                    .attr("data-tab-active", a.replace("#", "")),
                ...
                callbacks: {
                  parseAjax: function (e) {
                    var i = t(this.st.el),
                      ...
                      o = i.data("style") || "",
                      s = e.data;
                    e.data = `<div class="mfp-with-anim t4s-mfp-popup t4s-rte ${a}" id="${n}" style="${o}">${
